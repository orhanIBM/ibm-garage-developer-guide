...
Follow the instructions in the [development environment setup](/getting-started/dev-env-setup) to install the shell commands.
...
Opens the [Developer Dashboard](/getting-started-day-1/dashboard/) in the default browser. If a default browser has not been
...
can be used as a target for application deployments and/or to host the <Globals name="env" />.
