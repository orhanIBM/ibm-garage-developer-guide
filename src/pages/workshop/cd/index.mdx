...
1. Prerequisites
    - Complete lab [Deploy an Application using CI Pipelines with Tekton](/workshop/ci).
...
1. Congratulations you finished this activity, continue with the lab [Deploy a 3 tier Microservice using React, Node.js, and Java](/workshop/inventory)